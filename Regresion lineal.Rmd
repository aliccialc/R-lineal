...
## Mejoras del modelo transformando la variable respuesta

Las transformaciones en la respuesta y/o predictores pueden hacer ajuster y mejoras en los modelos. En este caso veremos la transformación en la respuesta mediante Box-Cox. Vamos a incluir un nuevo parámetro llamado Lambda.
